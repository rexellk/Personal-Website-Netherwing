...
const S = {
  ...
  desc:          { fontSize: 16, lineHeight: 1.8, color: "var(--pv-text-mid)", marginBottom: 20, fontFamily: "'Jost', sans-serif", fontWeight: 300 },
  metrics:       { display: "flex", flexWrap: "wrap", gap: 16, marginBottom: 20 },
  metric:        { fontSize: 14, color: "var(--pv-blue)", letterSpacing: "0.06em", fontFamily: "'Jost', sans-serif" },
